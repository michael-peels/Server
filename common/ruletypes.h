...
RULE_INT(Character, MaxFearDurationForPlayerCharacter, 1, "Maximum number of tics a player can be feared. 1 tic equls 6 seconds")
RULE_INT(Character, MaxCharmDurationForPlayerCharacter, 1, "Maximum number of tics a player can be charmed. 1 tic equls 6 seconds")
